...
/**   
 * @ClassName:ReceptionImageNewsServiceImpl
 * @Description: TODO(用一句话描述该文件做什么) 
 * @author 张兵 【390125214@qq.com】
 * @date 2012-8-2 上午9:11:53 
 * @version V1.0   
 * @Copyright: Copyright (c) 2013
 * @Company:	成都大学信息科学与技术学院重点工作室
 */
@Service("receptionImageNewsServiceImpl")
public class ReceptionImageNewsServiceImpl extends BasicServiceImp implements ReceptionImageNewsServiceDao{
